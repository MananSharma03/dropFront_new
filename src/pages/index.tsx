          ...
          {currentViewIndex === 2 && (
            ...
            >
              <div className="container mx-auto max-w-6xl">
                {/* Responsive Grid layout precisely matching the screenshot */}
                <div className="grid grid-cols-12 auto-rows-fr gap-4 h-[85vh]">
                  {cards.map((card, index) => (
                    ...
                    >
                      <motion.div
                        className={`bg-[${card.color}] text-${card.textColor} h-full w-full rounded-lg p-5 flex flex-col overflow-hidden`}
